...
DATA = [
    ...
    },
    {
        ...
        "Старый юз": "-",
        "Кд": "3 секунды",
        "Примечания": "\"секунд 20 из-за очень низкой оптимизации и отправки сообщений на 30 пользователей по 3 секунды\" – Кугона",
    ...
    },
    {
        ...
        "Дата смерти": "13 августа 2024 14 ноября 2024",
    ...
    },
    {
        "Бот": {
            "text": "ECHO ROOM [BETA]",
            "link": "https://drive.google.com/u/0/drive-viewer/AKGpihZ5uCkEeb5AtjukHKq68sWyQ11I5fiUXCeUSsJQdlTX1ykPTmseHyr1N0-MH4vcQmUSV8_ZQ4ZBvcAD9ae2qI9RId7PqsFzwBU=s2560",
